...
namespace OfficialCPP.Controllers
{
    public class DriversController : Controller
    {
        ...
        {
            return View(db.Drivers.ToList().OrderBy(a=>a.TimeIn));
        }
        ...
        public ActionResult Create([Bind(Include = "DriversId,Firstname,LastName,TimeIn,In,Out,TimeOut")] Driver driver)
        {
